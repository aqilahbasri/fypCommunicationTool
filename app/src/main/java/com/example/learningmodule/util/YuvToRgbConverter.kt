...
package com.example.learningmodule.util
...
import com.example.learningmodule.BuildConfig
...
class YuvToRgbConverter(context: Context) {
    ...
    private fun imageToByteBuffer(image: Image, outputBuffer: ByteArray) {
        if (com.example.learningmodule.BuildConfig.DEBUG && image.format != ImageFormat.YUV_420_888) {
