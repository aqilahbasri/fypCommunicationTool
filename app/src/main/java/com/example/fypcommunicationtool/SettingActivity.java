...
public class SettingActivity extends AppCompatActivity {
                    ...
                    addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(com.example.fypcommunicationtool.SettingActivity.this, "Profile updated", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                String message = task.getException().toString();
                                Toast.makeText(com.example.fypcommunicationtool.SettingActivity.this, "Error : " + message, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                RootRef.child("Users").child(currentUserID).child("profileImage").setValue(downloadUrl)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                Toast.makeText(com.example.fypcommunicationtool.SettingActivity.this, "Image saved in database successfuly", Toast.LENGTH_SHORT).show();
                                                loadingBar.dismiss();
                                            }
                                            else{
                                                String message = task.getException().toString();
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(com.example.fypcommunicationtool.SettingActivity.this, com.example.fypcommunicationtool.MainActivity.class);
